...
async function exportPDF() {
  ...
  try {
    ...
    status.value = 'Gagal mengunduh PDF. Pastikan dev server aktif (npm run dev) lalu coba lagi.'
  } finally {
        ...
        <section class="preview-area"><div class="section-title"><span class="step">PREVIEW</span><div><h2>Hasil sertifikat</h2><p>Pratinjau dari data penerima aktif.</p></div></div><article class="certificate" :style="{ '--accent': template.accent }"><div class="corner c-tl"></div><div class="corner c-tr"></div><div class="corner c-bl"></div><div class="corner c-br"></div><div class="inner"><div class="cert-header">
          ...
          <div class="footer-center">
            <div class="official-seal" aria-hidden="true">
              <svg class="seal-svg" viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <path id="seal-top-arc" d="M 14 44 A 30 30 0 0 1 74 44" />
                  <path id="seal-bot-arc" d="M 74 44 A 30 30 0 0 1 14 44" />
                </defs>
                <path class="seal-scallop" d="M 44.00,2.50 L 51.17,7.93 L 59.88,5.66 L 64.43,13.42 L 73.34,14.66 L 74.58,23.57 L 82.34,28.12 L 80.07,36.83 L 85.50,44.00 L 80.07,51.17 L 82.34,59.88 L 74.58,64.43 L 73.34,73.34 L 64.43,74.58 L 59.88,82.34 L 51.17,80.07 L 44.00,85.50 L 36.83,80.07 L 28.12,82.34 L 23.57,74.58 L 14.66,73.34 L 13.42,64.43 L 5.66,59.88 L 7.93,51.17 L 2.50,44.00 L 7.93,36.83 L 5.66,28.12 L 13.42,23.57 L 14.66,14.66 L 23.57,13.42 L 28.12,5.66 L 36.83,7.93 L 44.00,2.50 Z" />
                <circle cx="44" cy="44" r="30" class="seal-bg" />
                <circle cx="44" cy="44" r="27" class="seal-ring-outer" />
                <circle cx="44" cy="44" r="23" class="seal-ring-inner" />
                <circle cx="44" cy="12" r="1.3" class="seal-dot" />
                <circle cx="76" cy="44" r="1.3" class="seal-dot" />
                <circle cx="44" cy="76" r="1.3" class="seal-dot" />
                <circle cx="12" cy="44" r="1.3" class="seal-dot" />
                <text class="seal-label seal-label-top"><textPath href="#seal-top-arc" startOffset="50%" text-anchor="middle">AUTHENTIC</textPath></text>
                <text class="seal-label seal-label-bot"><textPath href="#seal-bot-arc" startOffset="50%" text-anchor="middle">VERIFIED</textPath></text>
                <path class="seal-emblem" d="M44,30 L47,40 L57,40 L49,46 L52,56 L44,49 L36,56 L39,46 L31,40 L41,40 Z" />
              </svg>
            </div>
